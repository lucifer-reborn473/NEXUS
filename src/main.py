...
if __name__ == "__main__":
    fileName = "/Users/husain/Library/CloudStorage/OneDrive-iitgn.ac.in/semester_8/compilers/Our_Compiler/compiler-project/src/examples/sample-code.txt"
    try:
